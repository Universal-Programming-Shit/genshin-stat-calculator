...
export const mainStatScalings: { [key: Stars]: { [key: Stats]: (level: number) => number } } = {
    [Stars.S3]: {
      ...
      [Stats.CRIT_DAMAGE]: linearScaling(0.070, 0.308, 12),
      [Stats.HEALING_BONUS]: linearScaling(0.040, 0.178, 12),
    },
    [Stars.S4]: {
      ...
      [Stats.ENERGY_RECHARGE]: linearScaling(0.070, 0.387, 16),
    ...
    [Stars.S5]: {
      ...
      [Stats.HP_PERC]: linearScaling(0.070, 0.466, 20),
      [Stats.ATTACK_PERC]: linearScaling(0.070, 0.466, 20),
      [Stats.DEF_PERC]: linearScaling(0.087, 0.583, 20),
      [Stats.PHYSICAL_DAMAGE]: linearScaling(0.087, 0.583, 20),
      [Stats.ELEMENTAL_DAMAGE]: linearScaling(0.070, 0.466, 20),
